...
### Length of the subchains in stage 2 of 
...
### Path to the stan script for the HPV modelused for the subchains in stage 2 of delta-SMI
hpv_model_poisson_stan_path = input.df$value[which(input.df$param == "hpv_model_poisson_stan_path")]
### Path to the stan script for the HPV model used for the main chain in stage 1 of delta-SMI
hpv_model_whole_abc_smi_stan_path = input.df$value[which(input.df$param == "hpv_model_whole_abc_smi_stan_path")]
...
hpv_model_whole_abc_smi_stan = stan_model(file = hpv_model_whole_abc_smi_stan_path)
...
hpv_abc_smi_stan_stage1 = sampling( hpv_model_whole_abc_smi_stan,
...
for(index in 1:nrow(hpv_theta_abc_smi)){
  ...
  # Extract the last theta estimates from stage 2 of ABC-SMI 
